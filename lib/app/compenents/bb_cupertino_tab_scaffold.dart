...
/// Coordinates tab selection between a [BBCupertinoTabBar] and a [CupertinoTabScaffold].
///
/// The [index] property is the index of the selected tab. Changing its value
/// updates the actively displayed tab of the [BBCupertinoTabScaffold] the
/// [BBCupertinoTabController] controls, as well as the currently selected tab item of
/// its [BBCupertinoTabBar].
///
/// {@tool sample}
///
/// [BBCupertinoTabController] can be used to switch tabs:
///
/// ```dart
/// class MyBBCupertinoTabScaffoldPage extends StatefulWidget {
///   @override
///   _BBCupertinoTabScaffoldPageState createState() => _BBCupertinoTabScaffoldPageState();
/// }
///
/// class _BBCupertinoTabScaffoldPageState extends State<MyBBCupertinoTabScaffoldPage> {
///   final BBCupertinoTabController _controller = BBCupertinoTabController();
///
///   @override
...
/// See also:
///
/// * [BBCupertinoTabScaffold], a tabbed application root layout that can be
///   controlled by a [BBCupertinoTabController].
class BBCupertinoTabController extends ChangeNotifier {
  /// Creates a [BBCupertinoTabController] to control the tab index of [BBCupertinoTabScaffold]
  /// and [BBCupertinoTabBar].
  ///
  ...
  BBCupertinoTabController({ int initialIndex = 0 })
    : _index = initialIndex,
  ...
  /// [BBCupertinoTabScaffold] controlled by this [BBCupertinoTabController], as well
  /// as the currently selected tab item of its [BBCupertinoTabScaffold.tabBar].
  ///
...
/// behind the tab bar.
///
/// A [tabBar] and a [tabBuilder] are required. The [BBCupertinoTabScaffold]
/// will automatically listen to the provided [BBCupertinoTabBar]'s tap callbacks
...
/// create its own [BBCupertinoTabController] and manage it internally. Otherwise
...
/// [BBCupertinoTabScaffold] may lose some tabs' state in the process.
///
...
/// See also:
///
///  * [BBCupertinoTabBar], the bottom tab bar inserted in the scaffold.
///  * [BBCupertinoTabController], the selection state of this widget
...
class BBCupertinoTabScaffold extends StatefulWidget {
  ...
  BBCupertinoTabScaffold({
    ...
    this.resizeToAvoidBottomInset = true,
       ...
       assert(
         ...
         "The BBCupertinoTabController's current index ${controller.index} is "
         'out of bounds for the tab bar with ${tabBar.items.length} tabs'
       ),
       super(key: key);

  /// The [tabBar] is a [BBCupertinoTabBar] drawn at the bottom of the screen
  /// that lets the user switch between different tabs in the main content area
  /// when present.
  ///
  /// The [BBCupertinoTabBar.currentIndex] is only used to initialize a
  /// [BBCupertinoTabController] when no [controller] is provided. Subsequently
  /// providing a different [BBCupertinoTabBar.currentIndex] does not affect the
  /// scaffold or the tab bar's active tab index. To programmatically change
  /// the active tab index, use a [BBCupertinoTabController].
  ///
  /// If [BBCupertinoTabBar.onTap] is provided, it will still be called.
  /// [BBCupertinoTabScaffold] automatically also listen to the
  /// [BBCupertinoTabBar]'s `onTap` to change the [controller]'s `index`
  /// and change the actively displayed tab in [BBCupertinoTabScaffold]'s own
  /// main content area.
  ///
  ...
  ///
  /// Must not be null.
  final BBCupertinoTabBar tabBar;
  ...
  ///
  /// Defaults to null.
  final BBCupertinoTabController controller;
  ...
  @override
  _BBCupertinoTabScaffoldState createState() => _BBCupertinoTabScaffoldState();
}

class _BBCupertinoTabScaffoldState extends State<BBCupertinoTabScaffold> {
  BBCupertinoTabController _controller;
  ...
  void _updateTabController({ bool shouldDisposeOldController = false }) {
    final BBCupertinoTabController newController =
      // User provided a new controller, update `_controller` with it.
      widget.controller
      ?? BBCupertinoTabController(initialIndex: widget.tabBar.currentIndex);
  ...
  @override
  void didUpdateWidget(BBCupertinoTabScaffold oldWidget) {
        ...
        tabFocusNodes.addAll(
          List<FocusScopeNode>.generate(
            widget.tabCount - tabFocusNodes.length,
              (int index) => FocusScopeNode(debugLabel: '$BBCupertinoTabScaffold Tab ${index + tabFocusNodes.length}'),
          ),
        );
      }
    }
...
///
/// When used as [CupertinoTabScaffold.tabBar], by default `BBCupertinoTabBar` has
...
/// See also:
///
///  * [CupertinoTabScaffold], which hosts the [BBCupertinoTabBar] at the bottom.
///  * [BottomNavigationBarItem], an item in a [BBCupertinoTabBar].
class BBCupertinoTabBar extends StatelessWidget implements PreferredSizeWidget {
  /// Creates a tab bar in the iOS style.
  const BBCupertinoTabBar({
    Key key,
    @required this.items,
    this.onTap,
    this.currentIndex = 0,
  ...
  /// The border of the [BBCupertinoTabBar].
  ///
  ...
  /// Create a clone of the current [BBCupertinoTabBar] but with provided
  /// parameters overridden.
  BBCupertinoTabBar copyWith({
    Key key,
